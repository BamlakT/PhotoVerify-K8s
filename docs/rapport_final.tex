...
\begin{titlepage}
    ...
    \begin{tcolorbox}[colback=lightgray, colframe=primaryblue, width=0.8\textwidth, arc=3mm]
        \centering
        \large\bfseries Rapport de Projet Cloud\\[0.3cm]
        \normalsize Déploiement Kubernetes sur Minikube\\[0.5cm]
        \normalsize
        \textbf{Auteurs :} Bamlak GURARA, Sami BOUALAMI\\[0.3cm]
        \textbf{École :} EFREI Paris\\[0.3cm]
        \textbf{Cours :} Intégration Cloud
    \end{tcolorbox}
...
Ce rapport presente une analyse detaillee de notre implementation, accompagnee de captures d'ecran illustrant chaque etape du processus. Les figures qui suivent demontreront l'interface utilisateur, le flux de donnees, et l'architecture technique deployee sur Kubernetes.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{screenshots/homepage.png}
    \caption{Page d'accueil de PhotoVerify avec le bouton d'upload principal}
    \label{fig:homepage}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{screenshots/upload_form.png}
    \caption{Formulaire d'upload montrant la selection de fichier et les champs de metadonnees}
    \label{fig:upload}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{screenshots/account.png}
    \caption{Interface de gestion de compte utilisateur avec signature crypto}
    \label{fig:account}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Page d'enregistrement avec configuration du profil utilisateur}
    \label{fig:register}
\end{figure}
...
% ----------------------------------------------------------------------------
% CAPTURES GOOGLE CLOUD SKILLS
% ----------------------------------------------------------------------------
\section{Captures Google Cloud Skills}

Dans le cadre de ce projet, nous avons également suivi des formations sur Google Cloud Skills Boost pour acquérir des compétences pratiques sur les technologies cloud.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{lab_screenshots/bamlak_lab_completion.png}
    \caption{Progression des labs Google Cloud Skills – Bamlak GURARA}
    \label{fig:bamlak_labs}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{lab_screenshots/sami_lab_completion.png}
    \caption{Progression des labs Google Cloud Skills – Sami BOUALAMI}
    \label{fig:sami_labs}
\end{figure}

Ces formations nous ont permis de mieux comprendre les services managés et les bonnes pratiques de déploiement sur cloud, complémentant parfaitement notre expérience avec Kubernetes sur Minikube.
